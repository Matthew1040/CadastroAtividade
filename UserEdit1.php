...
<nav class="navbar navbar-expand-lg bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-4 mb-lg-8">
...
<a class="btn btn-success" href="novo-usuario.php" role="button">Novo Usuário</a>
<a class="btn btn-warning" href="listar-usuarios.php" role="button">Listar Usuários</a>
